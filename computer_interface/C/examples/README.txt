...
Rename Makefile_win / Makefile_linux to Makefile according to your OS.
...
In order get the example working on Linux, open it with a root privileges. For example:
	sudo ./main
